...
import { addUpdateLocationContentCms, deleteCms, deleteLocationContent, fetchAllLocations, getActiveLocaionContent, getActiveSlug, getAllCms, getCmsBySlug, getLocationContentBySlug, saveCms, updateLocationContentStatus, updateStatus } from "../controllers/cms.controller.js";
...
cmsRouter.post("/add-location-content", addUpdateLocationContentCms);
...
cmsRouter.get("/active-location-content/:city", getActiveLocaionContent);
